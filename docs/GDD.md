...
Название мира/концепта: `Mandate Cities`.
...
Игрок восстанавливает умирающий район под мандатом фракции: строит дороги, жилье, логистику и коммунальные сети, но каждый успех повышает требования граждан, давление покровителя и риск кризисов.
...
игрок не строит идеальный город в вакууме. Игрок пытается создать город, который выдержит собственный рост, политический мандат, гражданские ожидания и кризисы мира после Долгого Провала.
